          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <fieldset>
                ...
                <!--frd-->
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-couriername"><?php echo $entry_couriername; ?></label>
                  <div class="col-sm-10">
                    <select name="couriername" id="input-couriername" class="form-control">
                      <option value=""><?php echo $text_select; ?></option>
                      <?php foreach ($services as $service) { ?>
                      <?php if ($service['value'] == $couriername) { ?>
                      <option value="<?php echo $service['value']; ?>" selected="selected"><?php echo $service['text']; ?></option>
                      <?php } else { ?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-awbnumber"><?php echo $entry_awbnumber; ?></label>
                  <div class="col-sm-10">
