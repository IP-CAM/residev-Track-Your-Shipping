	...
	public function add() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if (!$json) {
				...
				//frd
				if (isset($this->request->post['awbnumber'])) {
					$order_data['awbnumber'] = $this->request->post['awbnumber'];
				} else {
					$order_data['awbnumber'] = '';
				}
				if (isset($this->request->post['couriername'])) {
					$order_data['couriername'] = $this->request->post['couriername'];
				} else {
					$order_data['couriername'] = '';
				}
